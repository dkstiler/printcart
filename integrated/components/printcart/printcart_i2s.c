/*
This is a simple, hacky I2S driver that is used to control the I2S peripheral in parallel mode.

Note that the waveform template is also defined here.
*/
...
//This is the waveform template.
static uint16_t waveform_tpl[]={
	//old, duplicates lines on 2nd color cart
//	0x2,0xc005,0xc105,0xc146,0x46,0x4005,0x4105,0x4116,0x16,0x4005,0x4105,0x4306,0x606,0x4405,0x4505,0x4526,0x426,0x406,0x4000,0x4000,0x4080,0x880,0x800,0x800,0x800,0x800,0x800
	//works on 2nd color cart
	0x4,0xc004,0xc105,0xc145,0x46,0x6,0x4105,0x4115,0x16,0x4006,0x4105,0x4305,0x606,0x4406,0x4505,0x4525,0x426,0x406,0x4004,0x4000,0x4080,0x880,0x800,0x800,0x800,0x800,0x800
	//old, works on bw cart
	//0x2,0xc005,0xc105,0xc146,0x46,0xc005,0xc105,0xc116,0x16,0x4005,0x4105,0x4306,0x606,0x405,0x505,0x526,0x426,0x406,0x4000,0x4000,0x4080,0x880,0x800,0x800,0x800,0x800,0x800
	//new bw cart
	//0x4,0xc004,0xc105,0xc145,0x46,0x6,0xc105,0xc115,0x16,0x4006,0x4105,0x4305,0x606,0x406,0x505,0x525,0x426,0x406,0x4004,0x4000,0x4080,0x880,0x800,0x800,0x800,0x800,0x800
};
...
void i2s_parallel_setup(volatile i2s_dev_t *dev, const i2s_parallel_config_t *cfg) {
	...
	dev->sample_rate_conf.rx_bck_div_num=12;  //Divider. 40MHz/x
	dev->sample_rate_conf.tx_bck_div_num=12;
